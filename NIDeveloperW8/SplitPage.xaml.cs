...
namespace NIDeveloperW8
{
    /// <summary>
    /// A page that displays a group title, a list of items within the group, and details for the
    /// currently selected item.
    /// </summary>
    public sealed partial class SplitPage : NIDeveloperW8.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
           /* // TODO: Create an appropriate data model for your problem domain to replace the sample data
            ...
            blogModel.loadData();
            this.DefaultViewModel["Group"] = blogModel.Items;
            ...
            //rootPage.NotifyUser(String.Format("Navigating to: {0}", "http://www.nideveloper.co.uk"), NotifyType.StatusMessage);
